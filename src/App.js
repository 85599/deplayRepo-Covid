...
class App extends React.Component {
    ...
    render() {
        ...
        return <div className='container'>
            ...
            <p>Developer ❤ @Khushal Jain</p>
        <ul className='list'>
        <li><SocialMediaIconsReact icon="linkedin" url="https://www.linkedin.com/in/khushal-jain-3a2717192/" /></li>
        <li><SocialMediaIconsReact icon="mail" url="khushaljain023@gmail.com" /></li>
        <li><SocialMediaIconsReact icon="instagram" url="https://www.instagram.com/callmejainsahab_/"/></li>
        </ul> 
        </div>
    }
}
